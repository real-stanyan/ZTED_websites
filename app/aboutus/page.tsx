...
export default function Culture() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      if (geoRef.current) {
        ...
        if (distanceFromTopOfViewport < 200) {
  ...
  return (
    <div className="min-w-full text-black bg-aboutus-title bg-no-repeat bg-fixed bg-left bg-[length:300px_600px]">
      ...
      {/* 河南地理位置 */}
      <div
        className="h-[90vh] pl-[300px] pr-[80px] overflow-hidden border border-black"
        ref={geoRef}
        title="河南地理位置"
      >
        <h1 className="text-[2.5vw] my-[2vw] ml-[-1vw]">河南地理位置</h1>
        ...
        <Image
          ...
          width={2000}
          height={2000}
          className="h-[auto] w-[30vw] mx-auto my-[1vw]"
        />
